...
const ThrilerCategory = () => {
  ...
  const books = historyBooks.filter(book => book.Category === "Thrilar")

  return (
      <div>
          <div className="bg-sky-800 rounded-xl my-5 pb-7">
              <h1 className="text-center text-3xl mx-auto font-bold pt-7 text-white">Thrilar Library</h1>
...
export default ThrilerCategory;